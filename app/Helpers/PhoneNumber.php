...
class PhoneNumber
{
     ...
     */
    public static function detect_number($number)
    {
        ...
        $start_numbers = array_keys(self::$carriers_number);
        ...
        foreach ($start_numbers as $start_number) {
            ...
            $check = self::start_with($start_number, $number);
            if ($check) {
                return self::$carriers_number[$start_number];
            }
        }
