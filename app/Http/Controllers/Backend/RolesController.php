...
class RolesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("backend.roles.create", compact('module_title', 'module_name', 'module_icon', 'module_action', 'roles', 'permissions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('backend.roles.index'))->with('flash_success', "$module_name added!");
    }
    ...
    public function edit($id)
    {
        ...
        return view("backend.roles.edit", compact('module_title', 'module_name', "$module_name_singular", 'module_name_singular', 'module_icon', 'module_action', 'permissions'));
    }
