...
trait GeneratesPdfTrait
{
    ...
    public function getFieldsArray()
    {
        ...
        $companyAddress = $this->company->addressCompany ?? new Address();
        ...
        $fields = [
            ...
            '{SHIPPING_ADDRESS_STREET_1}' => $shipAddress,
