...
<div class="d-flex justify-content-between align-items-center pb-2 pt-4 pb-md-4">
    ...
    <div class="d-block d-sm-flex">
        ...
        <div class="mb-3 mb-md-0">
            <button type="button" class="btn btn-gray-800 d-inline-flex alignpitems-center dropdown-toggle arrow-none" data-bs-toggle="dropdown" aria-expanded="false">
                More
            ...
            <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M2.94 6.412A2 2 0 002 8.108V16a2 2 0 002 2h12a2 2 0 002-2V8.108a2 2 0 00-.94-1.696l-6-3.75a2 2 0 00-2.12 0l-6 3.75zm2.615 2.423a1 1 0 10-1.11 1.664l5 3.333a1 1 0 001.11 0l5-3.333a1 1 0 00-1.11-1.664L10 11.798 5.555 8.835z" clip-rule="evenodd"></path></svg>
                    Mark as read
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path></svg>
                    Snooze
                </a>
...
<div class="message-wrapper border-0 bg-white shadow rounded mb-4">
    <div class="card hover-state border-bottom rounded-0 rounded-top py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            <div class="col-1 align-items-center px-0 d-none d-lg-flex">
                ...
                <svg class="icon icon-sm rating-star d-none d-lg-inline-block" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
            </div>
            <div class="col-10 col-lg-2 ps-0 ps-lg-3 pe-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <img src="../assets/img/team/profile-picture-1.jpg" class="avatar-sm rounded-circle me-3" alt="Avatar">
                    <span class="h6 fw-bold mb-0">Roy Fendley</span>
                </a>
            </div>
            ...
            <div class="col-12 col-lg-7 d-flex align-items-center mt-3 mt-lg-0 ps-0">
                <a href="./single-message.html" class="fw-normal text-gray-600-900 truncate-text">
                    <span class="fw-bold ps-lg-5">Long time no see - Can we help you set up email forwarding?</span> <span class="fw-bold d-none d-md-inline">We’ve noticed you haven’t set up email forwarding and we could help you</span>
                </a>
            </div>
        </div>
    </div>
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <img src="../assets/img/team/profile-picture-3.jpg" class="avatar-sm rounded-circle me-3" alt="Avatar">
                    <span class="h6 fw-bold mb-0">Bonnie Green</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
            ...
            <div class="col-12 col-lg-7 d-flex align-items-center mt-3 mt-lg-0 ps-0">
                <a href="./single-message.html" class="fw-normal text-gray-900 truncate-text">
                    <span class="fw-bold ps-lg-5">Long time no see - Can we help you set up email forwarding?</span> <span class="fw-bold d-none d-md-inline">We’ve noticed you haven’t set up email forwarding and we could help you</span>
                </a>
            </div>
        </div>
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <div class="avatar-sm bg-secondary d-flex align-items-center justify-content-center rounded me-3"><span class="small fw-bold">SA</span></div>
                    <span class="h6 fw-bold mb-0">Scott Anderson</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
            ...
            <div class="col-12 col-lg-7 d-flex align-items-center mt-3 mt-lg-0 ps-0">
                <a href="./single-message.html" class="fw-normal text-gray-600 truncate-text">
                    <span class="fw-normal ps-lg-5">Long time no see - Can we help you set up email forwarding?</span> <span class="d-none d-md-inline">We’ve noticed you haven’t set up email forwarding and we could help you</span>
                </a>
            </div>
        </div>
    </div>
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <img src="../assets/img/team/profile-picture-4.jpg" class="avatar-sm rounded-circle me-3" alt="Avatar">
                    <span class="h6 fw-bold mb-0">Ronnie Buchanan</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <img src="../assets/img/team/profile-picture-3.jpg" class="avatar-sm rounded-circle me-3" alt="Avatar">
                    <span class="h6 fw-bold mb-0">Jane Rinehart</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <div class="avatar-sm bg-purple d-flex align-items-center justify-content-center rounded me-3"><span class="small text-white fw-bold">JG</span></div>
                    <span class="h6 fw-bold mb-0">John Ginther</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <img src="../assets/img/team/profile-picture-6.jpg" class="avatar-sm rounded-circle me-3" alt="Avatar">
                    <span class="h6 fw-bold mb-0">George Driskell</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <div class="avatar-sm bg-purple d-flex align-items-center justify-content-center rounded me-3"><span class="small text-white fw-bold">JB</span></div>
                    <span class="h6 fw-bold mb-0">John Benny</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
                <div class="text-muted small d-none d-lg-block">Jun 14</div>
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <img src="../assets/img/team/profile-picture-5.jpg" class="avatar-sm rounded-circle me-3" alt="Avatar">
                    <span class="h6 fw-bold mb-0">Flora Maresca</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
                <div class="text-muted small d-none d-lg-block">Jun 15</div>
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <div class="avatar-sm bg-warning d-flex align-items-center justify-content-center rounded me-3"><span class="small text-white fw-bold">T</span></div>
                    <span class="h6 fw-bold mb-0">Themesberg</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
    ...
    <div class="card hover-state border-bottom rounded-0 py-3">
        <div class="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
            ...
            <div class="col-10 col-lg-2 ps-0 ps-lg-3">
                <a href="#" class="d-flex align-items-center">
                    <img src="../assets/img/team/profile-picture-7.jpg" class="avatar-sm rounded-circle me-3" alt="Avatar">
                    <span class="h6 fw-bold mb-0">Jane Rinehart</span>
                </a>
            </div>
            <div class="col-2 col-lg-2 d-flex align-items-center justify-content-end px-0 order-lg-4">
