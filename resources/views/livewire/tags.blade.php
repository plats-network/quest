<title>{{ env('APP_NAME', 'Plats') }} Dashboard - Tag Management</title>
<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Tag Management</h2>
            <p class="mb-0">Your tag management dashboard template.</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{route('new-tag')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center"><svg
    ...
    <div class="card card-body shadow-sm table-wrapper table-responsive">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-6 col-lg-4 d-flex">
                    <div class="input-group me-2 me-lg-3">
                        ...
                        <input wire:model="search" type="text" class="form-control" placeholder="Search tags">
                    </div>
        ...
        <table class="table user-table table-hover align-items-center" style="overflow-x: clip">
            ...
            <tr>
                ...
                <th class="border-bottom">
                    <a wire:click="sortBy('color')" class="text-default me-3">
                        <span>Color</span>
    ...
    <span><span class="badge text-white"
                style="background-color:#f5365c">Hot</span></span>
                </td>                        <td>
    ...
    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
        <a class="dropdown-item rounded-top"
           href="edit-tag/1"><span
                class="fas fa-user-shield me-2"></span> Edit tag</a>
                                                                                                <a onclick="confirm('Are you sure you want to remove this tag?') || event.stopImmediatePropagation()"
                                                                                                   wire:click="delete(1)"
                                                                                                   class="dropdown-item text-danger rounded-bottom"><span
                                                                                                        class="fas fa-user-times me-2"></span>Delete tag</a>
    </div>
</div></span>
                </td>
            </tr>                                        <tr>
    ...
    <span><span class="badge text-white"
                style="background-color:#11cdef">New</span></span>
                </td>                        <td>
                    <span>22 Mar 2023</span>
                </td>                                                <td>
    <span><div class="btn-group">
    ...
    <span><span class="badge text-white"
                style="background-color:#5e72e4">Trending</span></span>
                </td>                        <td>
                    <span>22 Mar 2023</span>
                </td>                                                <td>
    <span><div class="btn-group">
