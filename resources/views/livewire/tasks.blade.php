<div class="d-lg-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="col-12 col-lg-6 d-flex justify-content-lg-end">
        <input type="text" class="form-control w-100 fmxw-300" id="exampleInputIconLeft" placeholder="Search Tasks Here" aria-label="Search" aria-describedby="basic-addon3">
    </div>
</div>
