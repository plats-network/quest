...
<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Item Management</h2>
            <p class="mb-0">Your item management dashboard template.</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="new-item" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center"><svg
        ...
        <table class="table user-table table-hover align-items-center" style="overflow-x: clip">
            ...
            <tr>
                <td>
                    ...
                    <span><img src="items/img1.jpg" class="rounded" style="max-width: 150px;"></span>
                </td>                        <td>
    <span><span class="badge text-white"
                style="background-color:#f5365c">Hot</span>
                                                        <span class="badge text-white"
                                                              style="background-color:#5e72e4">Trending</span>
                                                        <span class="badge text-white"
        ...
        <a class="dropdown-item d-flex align-items-center"
           href="edit-item/1"><span
                ...
                <td>
                    ...
                    <span><img src="items/img3.jpg" class="rounded" style="max-width: 150px;"></span>
                </td>                        <td>
    <span><span class="badge text-white"
        ...
        <a class="dropdown-item d-flex align-items-center"
           href="edit-item/3"><span
                ...
                <td>
                    ...
                    <span><img src="items/img2.jpg" class="rounded" style="max-width: 150px;"></span>
                </td>                        <td>
    <span><span class="badge text-white"
                style="background-color:#f5365c">Hot</span></span>
                </td>                        <td>
