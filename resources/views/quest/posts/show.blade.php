...
@section('content')
    <div class="" id="content">
        ...
        <section data-section-id="1" data-share="" data-category="blog-content-white-pattern" data-component-id="5d44a180_02_awz" class="py-16 md:py-24 bg-white" style="background-image: url('flex-ui-assets/elements/pattern-white.svg'); background-repeat: no-repeat; background-position: center top;" data-config-id="auto-img-4">
                        ...
                        <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
                            <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                ...
                                <ul class="pl-0 text-gray-500 list-none dark:text-gray-400">
                                    <li><a href="https://tailwindui.com/" rel="nofollow" class="text-blue-600 dark:text-blue-500 hover:underline">Detail >></a></li>
                                </ul>
                            </div>
                        </div>
                        <h2 id="accordion-color-heading-2" class="mb-0">
