            ...
            <div class=" bg-white rounded-lg border border-gray-200 shadow-md">
                <div class="flex flex-col items-stretch">
                    ...
                    <div class="p-3 sm:p-5">
                        ...
                        <p>
                            <a href="{{route('quest.categories.show', [encode_id($$module_name_singular->category_id), $$module_name_singular->category->slug])}}" class="bg-blue-100 hover:bg-blue-200 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded">{{$$module_name_singular->category_name}}</a>
                        </p>
                        <p>
                            @foreach ($$module_name_singular->tags as $tag)
                            <a href="{{route('quest.tags.show', [encode_id($tag->id), $tag->slug])}}" class="bg-blue-100 hover:bg-blue-200 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded">
                                {{$tag->name}}
                            </a>
