...
@section('content')
    ...
    <div class="" id="content">
        ...
        <section data-section-id="1" data-share="" data-category="contacts-white-pattern" data-component-id="defd6ea9_02_awz" class="py-20 bg-white" style="background-image: url('https://shuffle.dev/flex-ui-assets/elements/pattern-white.svg'); background-position: center;" data-config-id="auto-img-1">
            <div class="container px-4 mx-auto">
                <div class="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
                    <div class="w-full lg:w-1/2 mb-10 lg:mb-0">
                        <span class="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-9xl" data-config-id="auto-txt-1-2">Contact</span>
                        <h3 class="mb-4 text-4xl md:text-5xl text-darkCoolGray-900 font-bold tracking-tighter leading-tight" data-config-id="auto-txt-2-2">Let&rsquo;s stay connected</h3>
                        <p class="text-lg md:text-xl text-coolGray-500 font-medium" data-config-id="auto-txt-3-2">It&apos;s never been easier to get in touch with Flex. Call us, use our live chat widget or email and we&apos;ll get back to you as soon as possible!</p>
                    </div>
                    <div class="w-full lg:w-auto">
                        <div class="flex flex-wrap justify-center items-center md:justify-start -mb-2"><a class="inline-block py-4 px-6 mb-2 md:mb-0 w-full md:w-auto md:mr-5 text-lg leading-6 text-coolGray-50 font-medium text-center bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm" href="#" data-config-id="auto-txt-4-2">Open Positions</a><a class="inline-block py-4 px-6 w-full md:w-auto text-lg leading-6 font-medium text-center text-coolGray-500 bg-white border border-coolGray-200 hover:border-coolGray-300 focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 rounded-md shadow-sm" href="#" data-config-id="auto-txt-5-2">About Us</a></div>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-4">
                            ...
                            <div class="w-full md:w-1/2 px-4 mb-10">
                                <div class="max-w-xs mx-auto">
                                    <div class="inline-flex mb-6 items-center justify-center w-12 h-12 bg-green-500 rounded-full">
                                        <svg class="h-6 text-white" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-1-2">
                                    ...
                                    <h3 class="mb-4 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900" data-config-id="auto-txt-6-2">Email</h3>
                                    <a class="text-lg md:text-xl text-coolGray-500 hover:text-coolGray-600 font-medium" href="/cdn-cgi/l/email-protection#81a2" data-config-id="auto-txt-7-2"><span class="__cf_email__" data-cfemail="20434f4e5441435460464c45580e434f">[email&#160;protected]</span></a>
                                </div>
                            </div>
                            <div class="w-full md:w-1/2 px-4 mb-10">
                                <div class="max-w-xs mx-auto">
                                    <div class="inline-flex mb-6 items-center justify-center w-12 h-12 bg-green-500 rounded-full">
                                        <svg class="h-6 text-white" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-2-2">
                                    ...
                                    <h3 class="mb-4 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900" data-config-id="auto-txt-8-2">Phone</h3>
                                    <p class="text-lg md:text-xl text-coolGray-500 font-medium" data-config-id="auto-txt-9-2">+ 7-843-672-431</p>
                                </div>
                            </div>
                            <div class="w-full md:w-1/2 px-4 mb-10 md:mb-0">
                                <div class="max-w-xs mx-auto">
                                    <div class="inline-flex mb-6 items-center justify-center w-12 h-12 bg-green-500 rounded-full">
                                        <svg class="h-6 text-white" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-3-2">
                                    ...
                                    <h3 class="mb-4 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900" data-config-id="auto-txt-10-2">Office</h3>
                                    <p class="text-lg md:text-xl text-coolGray-500 font-medium" data-config-id="auto-txt-11-2">1686, Geraldine Lane</p>
                                    <p class="text-lg md:text-xl text-coolGray-500 font-medium" data-config-id="auto-txt-12-2">New York, NY 10013</p>
                                </div>
                            </div>
                            <div class="w-full md:w-1/2 px-4">
                                <div class="max-w-xs mx-auto">
                                    <div class="inline-flex mb-6 items-center justify-center w-12 h-12 bg-green-500 rounded-full">
                                        <svg class="h-6 text-white" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-4-2">
                                    ...
                                    <h3 class="mb-9 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900" data-config-id="auto-txt-13-2">Socials</h3>
                                    <a class="inline-block mr-8 text-green-500 hover:text-green-600" href="#">
                                        <svg width="10" height="18" viewbox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-5-2">
                                    ...
                                    <a class="inline-block mr-8 text-green-500 hover:text-green-600" href="#">
                                        <svg width="19" height="16" viewbox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-6-2">
                                    ...
                                    <a class="inline-block mr-8 text-green-500 hover:text-green-600" href="#">
                                        <svg width="20" height="20" viewbox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-7-2">
                                    ...
                                    <a class="inline-block text-green-500 hover:text-green-600" href="#">
                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-8-2">
                    ...
                    <div class="w-full lg:w-1/2 px-4">
                        <div class="px-4 py-8 md:p-10 bg-coolGray-50 rounded-md">
                            <form>
                                <div class="mb-6">
                                    <label class="block mb-2 text-coolGray-800 font-medium leading-6" for="" data-config-id="auto-txt-15-2">Email</label>
                                    <input class="block w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50" type="email" placeholder="dev@shuffle.dev">
                                </div>
                                <div class="mb-6">
                                    <label class="block mb-2 text-coolGray-800 font-medium leading-6" for="" data-config-id="auto-txt-16-2">Message</label>
                                ...
                                <button class="block w-full py-4 px-6 text-lg leading-6 text-coolGray-50 font-medium text-center bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-md shadow-sm" data-config-id="auto-txt-14-2">Send</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <section data-section-id="1" data-share="" data-category="faqs-white-pattern" data-component-id="900595cb_04_awz" class="pt-24 bg-white" style="background-image: url('https://shuffle.dev/flex-ui-assets/elements/pattern-white.svg'); background-position: center;" data-config-id="auto-img-8">
            <div class="container px-4 mx-auto">
                <div class="max-w-4xl mb-16">
                    <span class="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium rounded-full shadow-sm" data-config-id="auto-txt-1-4">FAQ</span>
                    <h2 class="mb-4 text-4xl md:text-5xl leading-tight text-coolGray-900 font-bold tracking-tighter" data-config-id="auto-txt-2-4">Frequently Asked Questions</h2>
                    <p class="text-lg md:text-xl text-coolGray-500 font-medium" data-config-id="auto-txt-3-4">Flex is the only saas business platform that lets you run your business on one platform, seamlessly across all digital channels.</p>
                </div>
                <div class="flex flex-wrap pb-16 -mx-4">
                    <div class="w-full md:w-1/2 xl:w-1/3 px-4 mb-8">
                        <div class="md:max-w-xs">
                            <div class="inline-flex mb-6 items-center justify-center w-12 h-12 rounded-full bg-green-500">
                                <img src="https://shuffle.dev/flex-ui-assets/elements/faq/shield-icon.svg" alt="" data-config-id="auto-img-1-4">
                            </div>
                            <h3 class="mb-6 text-xl text-coolGray-900 font-bold" data-config-id="auto-txt-4-4">What shipping options do you have?</h3>
                            <p class="text-coolGray-500 font-medium" data-config-id="auto-txt-5-4">For USA domestic orders we offer FedEx and USPS shipping. Contact us via email to learn more.</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-1/3 px-4 mb-8">
                        <div class="md:max-w-xs">
                            <div class="inline-flex mb-6 items-center justify-center w-12 h-12 rounded-full bg-green-500">
                                <img src="https://shuffle.dev/flex-ui-assets/elements/faq/shield-icon.svg" alt="" data-config-id="auto-img-2-4">
                            </div>
                            <h3 class="mb-6 text-xl text-coolGray-900 font-bold" data-config-id="auto-txt-6-4">What payment methods do you accept?</h3>
                            <p class="text-coolGray-500 font-medium" data-config-id="auto-txt-7-4">Any method of payments acceptable by you. For example: We accept MasterCard, Visa.</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-1/3 px-4 mb-8">
                        <div class="md:max-w-xs">
                            <div class="inline-flex mb-6 items-center justify-center w-12 h-12 rounded-full bg-green-500">
                                <img src="https://shuffle.dev/flex-ui-assets/elements/faq/shield-icon.svg" alt="" data-config-id="auto-img-3-4">
                            </div>
                            <h3 class="mb-6 text-xl text-coolGray-900 font-bold" data-config-id="auto-txt-8-4">How long does it take to ship my order?</h3>
                            <p class="text-coolGray-500 font-medium" data-config-id="auto-txt-9-4">Orders are usually shipped within 1-2 business days after placing the order.</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-1/3 px-4 mb-8 xl:mb-0">
                        <div class="md:max-w-xs">
                            <div class="inline-flex mb-6 items-center justify-center w-12 h-12 rounded-full bg-green-500">
                                <img src="https://shuffle.dev/flex-ui-assets/elements/faq/shield-icon.svg" alt="" data-config-id="auto-img-4-4">
                            </div>
                            <h3 class="mb-6 text-xl text-coolGray-900 font-bold" data-config-id="auto-txt-10-4">What shipping options do you have?</h3>
                            <p class="text-coolGray-500 font-medium" data-config-id="auto-txt-11-4">For USA domestic orders we offer FedEx and USPS shipping. Contact us via email to learn more.</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-1/3 px-4 mb-8 md:mb-0">
                        <div class="md:max-w-xs">
                            <div class="inline-flex mb-6 items-center justify-center w-12 h-12 rounded-full bg-green-500">
                                <img src="https://shuffle.dev/flex-ui-assets/elements/faq/shield-icon.svg" alt="" data-config-id="auto-img-5-4">
                            </div>
                            <h3 class="mb-6 text-xl text-coolGray-900 font-bold" data-config-id="auto-txt-12-4">What payment methods do you accept?</h3>
                            <p class="text-coolGray-500 font-medium" data-config-id="auto-txt-13-4">Any method of payments acceptable by you. For example: We accept MasterCard, Visa.</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-1/3 px-4">
                        <div class="md:max-w-xs">
                            <div class="inline-flex mb-6 items-center justify-center w-12 h-12 rounded-full bg-green-500">
                                <img src="https://shuffle.dev/flex-ui-assets/elements/faq/shield-icon.svg" alt="" data-config-id="auto-img-6-4">
                            </div>
                            <h3 class="mb-6 text-xl text-coolGray-900 font-bold" data-config-id="auto-txt-14-4">How long does it take to ship my order?</h3>
                            <p class="text-coolGray-500 font-medium" data-config-id="auto-txt-15-4">Orders are usually shipped within 1-2 business days after placing the order.</p>
                        </div>
                    </div>
                </div>
                <div class="relative -mb-40 py-16 px-4 md:px-8 lg:px-16 bg-coolGray-800 rounded-md overflow-hidden">
                    <img class="absolute top-0 left-0 h-full w-full object-cover" src="https://shuffle.dev/flex-ui-assets/elements/pattern-dark.svg" alt="" data-config-id="auto-img-7-4">
                    <div class="relative max-w-max mx-auto text-center">
                        <h3 class="mb-2 text-2xl md:text-5xl leading-tight font-bold text-white tracking-tighter" data-config-id="auto-txt-16-4">Have any additional questions?</h3>
                        <p class="mb-6 text-base md:text-xl text-coolGray-400" data-config-id="auto-txt-17-4">Flex is a Small SaaS Business. Flex isn&rsquo;t a traditional company.</p>
                        <a class="inline-flex items-center justify-center px-7 py-3 h-14 w-full md:w-auto mb-2 md:mb-0 md:mr-4 text-lg leading-7 text-green-50 bg-green-500 hover:bg-green-600 font-medium focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm" href="#" data-config-id="auto-txt-18-4">Get in touch</a>
                    </div>
                </div>
            </div>
