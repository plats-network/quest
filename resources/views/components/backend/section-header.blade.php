...
<div class="d-flex justify-content-between">
    ...
    <div class="btn-toolbar d-block text-end" role="toolbar" aria-label="Toolbar with buttons">
        ...
        <a href='{{ route("backend.$module_name.index", ['post_id' => 1]) }}' class="btn btn-secondary btn-sm ms-1" data-toggle="tooltip" title="{{ __($module_title) }} List"><i class="fas fa-list-ul"></i> List</a>
        ...
        @endcan
        <a href="{{ route("backend.$module_name.index", ['post_id' => $data->post_id]) }}" class="btn btn-secondary btn-sm" data-toggle="tooltip" title="{{ ucwords($module_name) }} List"><i class="fas fa-list"></i> List</a>
        @endif
    </div>
    @endif
</div>
