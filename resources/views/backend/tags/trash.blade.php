    ...
    <div class="card-body">
        ...
        <x-backend.section-header>
            ...
            <x-slot name="subtitle">
                @lang(":module_name Management Dashboard", ['module_name'=>Str::title('Tags')])
            </x-slot>
            <x-slot name="toolbar">
                <x-backend.buttons.return-back />
                <a href='{{ route("backend.tags.index") }}' class="btn btn-secondary" data-toggle="tooltip" title="{{ ucwords('Tags') }} List"><i class="fas fa-list"></i> List</a>
            </x-slot>
        </x-backend.section-header>
