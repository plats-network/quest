...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Task Create</h2>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{route('backend.tasks.create', ['post_id' => $post_id])}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
    ...
    <x-backend.layouts.create :post_id="$post_id" :all_task_type="$all_task_type" :data="$$module_name_singular" :module_name="$module_name" :module_path="$module_path" :module_title="$module_title" :module_icon="$module_icon" :module_action="$module_action" />
