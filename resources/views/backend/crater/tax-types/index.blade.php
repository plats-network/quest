                ...
                <table class="table  table-centered table-hover table-nowrap mb-0 rounded">
                    ...
                    @foreach($taxTypes as $taxType)
                        <tr>
                            ...
                            <td>{{$taxType->id}}</td>
                            <td>
                                <a href="{{route('admin.tax-types.edit', ['unit' => $taxType])}}">{{$taxType->name}}</a></td>
                            <td>{{$taxType->slug}}</td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div
                                        ...
                                        <a class="dropdown-item d-flex align-items-center" href="{{route('admin.units.edit', ['unit', $taxType])}}">
