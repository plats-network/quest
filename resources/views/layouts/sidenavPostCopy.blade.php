...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-2 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="{{route('backend.posts.index')}}" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon me-3">
            ...
            <li class="nav-item {{ Request::segment($indexSegmentt) == 'dashboard' ? 'active' : '' }}">
        ...
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            ...
            <span class="sidebar-text" style="color: #fb503b;">@lang('Article')</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
              ...
              <path fill-rule="evenodd"
                ...
                <div class="multi-level collapse @if(!in_array(Request::segment($indexSegmentt), ['users', 'roles'])) show @else hide @endif" role="list" id="submenu-laravel" aria-expanded="true">
                    <ul class="flex-column nav">
                        <li class="nav-item {{ Request::segment($indexSegmentt) == 'posts' ? 'active' : Request::segment($indexSegmentt) }}">
                            <a href="{{route('backend.posts.index')}}" class="nav-link">
                                <span class="sidebar-text">@lang('Posts Item')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::segment($indexSegmentt) == 'categories' ? 'active' : '' }}">
                            <a href="{{route('backend.categories.index')}}" class="nav-link">
                                <span class="sidebar-text">@lang('Categories Item')</span>
                            </a>
                        </li>
                        {{--tag--}}
          ...
          <span>
            ...
            <li class="nav-item {{ Request::segment($indexSegmentt) == 'transactions' ? 'active' : '' }}">
          ...
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
              ...
              <path fill-rule="evenodd"
                    ...
                    <span class="sidebar-text">@lang('Transactions')</span>
                </a>
            </li>
            <li class="nav-item {{ Request::segment($indexSegmentt) == 'notifications' ? 'active' : '' }}">
                <a href="{{route('backend.notifications.index')}}" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                          xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
              <path fill-rule="evenodd"
                    ...
                    <span class="sidebar-text">@lang('Notifications')</span>
                </a>
            </li>


            <li class="nav-item {{ Request::segment($indexSegmentt) == 'backups' ? 'active' : '' }}">
                <a href="{{route('backend.backups.index')}}" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
  <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3v6.75m0 0l-3-3m3 3l3-3M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" />
</svg>
</span>
                    <span class="sidebar-text">@lang('Backups')</span>
                </a>
            </li>
            <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            ...
            <span class="sidebar-text">@lang('Access Control')</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
                ...
                <div class="multi-level collapse @if(in_array(Request::segment($indexSegmentt), ['users', 'roles'])) show @endif" role="list" id="submenu-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item {{ Request::segment($indexSegmentt) == 'users' ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('backend.users.index')}}">
                                <span class="sidebar-text">@lang('Users')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::segment($indexSegmentt) == 'roles' ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('backend.roles.index')}}">
                                <span class="sidebar-text">@lang('Roles')</span>
                            </a>
                        </li>
        ...
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            ...
            <span class="sidebar-text">@lang('Log Viewer')</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
                ...
                <div
                    class="multi-level collapse {{ Request::segment($indexSegmentt) == 'log-viewer' ? 'show' : '' }}"
                    role="list" id="submenu-components" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item {{ Request::segment($indexSegmentt) == 'buttons' ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::segment($indexSegmentt) == 'notifications' ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('log-viewer::logs.list') }}">
                                <span class="sidebar-text">@lang('Log by Days')</span>
                            </a>
                        </li>
