      ...
      <div class="d-flex align-items-center">
        ...
        <form class="navbar-search form-inline" id="navbar-search-main">
          <div class="input-group input-group-merge search-bar">
            ...
            <input type="text" class="form-control" id="topbarInputIconLeft" placeholder="@lang('Search')" aria-label="Search"
              aria-describedby="topbar-addon">
          </div>
        </form>
          <a href="{{route('quest.posts.index')}}" target="_blank">
              <button class="btn mx-1 me-2 btn-secondary" type="button">
                  <i class="fas fa-plus mx-1"></i>Connect Wallet</button>
          </a>
      </div>
      <!-- Navbar links -->
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown ms-lg-3">
          ...
          <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
            <a class="dropdown-item d-flex align-items-center" href="{{route('backend.users.profile', ['id' =>1])}}">
              ...
              <a class="dropdown-item d-flex align-items-center" href="{{route('backend.settings.list', ['id' =>1])}}">
                  <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                       xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd"
                            d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z"
